...
public class FormationTest extends TestCase {
	...
	public void testIsFusionnee() {
		assertTrue(new Formation("20210528",  null, null,300,"Active","Original",1).isFusionnee());
		assertFalse(new Formation("20210528",  null, null,300,"Fusionnee","Original",1).isFusionnee());
	}
}
